"""
Django settings for retro_adventure_game project.
"""
...
ROOT_URLCONF = 'retro_adventure_game.urls'
...
WSGI_APPLICATION = 'retro_adventure_game.wsgi.application'
...
if USE_SQLITE:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': env('DB_NAME', default='retro_adventure'),
